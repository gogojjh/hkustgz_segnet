...
'''
img_num = '086015'
img = cv2.imread('/data/Data/jjiao/dataset/FusionPortable_dataset_develop/sensor_data/mini_hercules/20230309_hkustgz_campus_road_day/data/frame_cam00/image/data/{}.png'.format(img_num))
...
cv2.imwrite(os.path.join('/save_data/ruoyu_data/white_denoise_img', '{}.jpg'.format(img_num)), img_stack)
print('img saved')
