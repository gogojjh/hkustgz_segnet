        ...
        for i, data_dict in enumerate(self.train_loader):
            ...
            if self.configer.get('iters') % self.configer.get('solver', 'display_iter') == 0 and \
                ...
                Log.info(
                    ...
                    'seg_loss={seg_loss:.5f} prob_ppc_loss={prob_ppc_loss:.5f} prob_ppd_loss={prob_ppd_loss:.5f} uncer_seg_loss={uncer_seg_loss:.5f} proto_diverse_loss={proto_diverse_loss:.5f}'.
                    format(
                        ...
                        uncer_seg_loss=uncer_seg_loss, proto_diverse_loss=proto_diverse_loss))
