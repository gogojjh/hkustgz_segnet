#!/usr/bin/env bash
cd /home/hkustgz_segnet/catkin_ws/src/hkustgz_segnet/src
...
CONFIGS="/home/hkustgz_segnet/configs/cityscapes/H_48_D_4_prob_proto.json"
CONFIGS_TEST="/home/hkustgz_segnet/configs/cityscapes/H_48_D_4_TEST.json"
...
echo "[single scale] test"
  python3 -u inference.py --configs ${CONFIGS} --drop_last y --data_dir ${DATA_DIR} \
